...
file_path = r"C:\Users\Administrator\Desktop\data_shuoming\fenkuai\img"    # 原始图像路径

raw_files = os.walk(file_path)              # 遍历所有图像
width, height = 768, 512                    # 修改后的图像尺寸大小

save_path = r"C:\Users\Administrator\Desktop\data_shuoming\fenkuai\img\after"  # 修改后图像存储的路径
