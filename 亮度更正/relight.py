...
class BatchRename():
    ...
    def __init__(self):
        self.path = r'D:\Deep-Learing\NetModel\ConvNet-seg2\dataset\TZB_1\testB'  # 表示需要命名处理的文件夹
        self.dir = r'D:\Deep-Learing\NetModel\ConvNet-seg2\dataset\TZB_1\light'  #上级目录
        ...
        for t in range(6,20):
            for item in filelist:
                if item.endswith('.png'):  # 初始的图片的格式为jpg格式的（或者源文件是png格式及其
                    ...
                    hist_res = cv2.calcHist([img], [0], None, [256], [0, 255])
